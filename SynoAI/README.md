...
```
* ToEmail [required]: The email recipient for SynoAi notifications
...
* Encryption [optional] (Default: ```None```):  The encryption method used by the host e.g. "Auto", "Ssl", "StartTls"
* Port [required]: The port used by the SMTP server e.g 25, 465, 587
