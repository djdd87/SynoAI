<template>
  <header class="p-4 bg-sky-900 text-white font-bold text-2xl flex justify-between">
    <div>
      <svg class="w-8 mr-2 inline" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="hidden w-64 md:block">
      <nav>
        <ul>
          ...
          <li class="p-1 mb-2">
            <NuxtLink to="/cameras" class="flex items-center">
              <svg class="w-6 mr-2" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul class="pl-10 text-sm">
              ...
              <li class="mt-3">
                <NuxtLink to="/cameras/2">
                  Secret Garden North
                </NuxtLink>
              </li>
              <li class="mt-3">
                <NuxtLink to="/cameras/3">
                  Secret Garden East
                </NuxtLink>
              </li>
              <li class="mt-3">
                <NuxtLink to="/cameras/4">
                  Side Gate
                </NuxtLink>
              </li>
              <li class="mt-3">
                <NuxtLink to="/cameras/5">
                  Patio
                </NuxtLink>
              </li>
            </ul>
